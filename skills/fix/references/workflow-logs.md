...
Use parallel `Explore` subagents with Glob/Grep to find issue locations.
...
Use `integration-test-executor` agent. If issues remain → keep T5 `in_progress`, loop back to Step 2.
