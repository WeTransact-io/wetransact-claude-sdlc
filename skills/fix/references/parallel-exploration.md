...
Task("senior-backend-engineer", "Fix backend for Issue A. Claim tasks via TaskUpdate.", "Fix A backend")
Task("senior-frontend-engineer", "Fix frontend for Issue A. Claim tasks via TaskUpdate.", "Fix A frontend")
Task("senior-backend-engineer", "Fix backend for Issue B. Claim tasks via TaskUpdate.", "Fix B backend")
Task("senior-frontend-engineer", "Fix frontend for Issue B. Claim tasks via TaskUpdate.", "Fix B frontend")
```
...
| 2+ independent issues | Task trees per issue + `senior-backend-engineer` + `senior-frontend-engineer` agents |
