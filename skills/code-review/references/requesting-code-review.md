...
**0. Analyze edge cases first:**
Before dispatching code-reviewer, use Explore subagents or Glob/Grep to find:
- Files affected by changes (not just modified files)
- Data flow paths that could break
- Edge cases and boundary conditions
- Potential side effects (see: `references/edge-case-scouting.md`)
