---
name: code-review
description: "Review code quality, receive feedback with technical rigor, verify completion claims. Use before PRs, after implementing features, when claiming task completion. Includes edge case detection and native Task pipeline orchestration."
---
...
**Process:**
1. Use Explore subagents with Glob/Grep to find affected files, data flows, error paths, boundary conditions
2. Review findings for potential issues
3. Address critical gaps before code review
...
- **Subagent-Driven:** Edge case analysis → Review after EACH task → Verify before next
- **Pull Requests:** Verify tests → Code-reviewer review → Merge
...
2. Analyze edge cases before review
3. Task-manage reviews for multi-file features
4. Evidence before claims

Verify. Analyze. Question. Then implement. Evidence. Then claim.
