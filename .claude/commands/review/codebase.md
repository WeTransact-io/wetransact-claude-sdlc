...
* Use WebSearch/WebFetch to search up to max 5 sources for the user's request, idea validation, best practices, challenges, and find the best possible solutions.
* Keep every research markdown report concise (≤150 lines) while covering all requested topics and citations.
* Use Explore subagents with Glob/Grep to search the codebase for files needed to complete the task
...
### Plan
* Use `implementation-planner` subagent to analyze research findings and codebase analysis to create an improvement plan following the progressive disclosure structure:
