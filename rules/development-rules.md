...
- When looking for docs, use `WebSearch` or `WebFetch` to explore latest documentation.
...
- Use the `Read` tool to view images/documents; describe details visually when needed
- Use `debug` skill for systematic analysis, debugging, and root cause investigation if needed
...
## Visual Aids
- Use ASCII diagrams in markdown for architecture and data flow visualization when needed
- Use Mermaid syntax in markdown code blocks for diagrams (flowcharts, sequence diagrams, ER diagrams)
