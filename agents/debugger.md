...
- **Skills**: activate `debug` skill to investigate issues and find solutions
...
2. **Data Collection**
   ...
   - Use `WebFetch`/`WebSearch` to read the latest docs of the packages/plugins
...
- **Package/Plugin Docs**: Use `WebFetch`/`WebSearch` to read the latest docs of the packages/plugins
- **Codebase Analysis**: Use Glob/Grep tools to explore and understand the project structure
