...
5. Main agent gathers all research and codebase analysis results, and pass them to `implementation-planner` subagent with the prompt to create a parallel-optimized implementation plan.
